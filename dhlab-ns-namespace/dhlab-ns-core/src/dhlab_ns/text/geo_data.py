...
from dhlab_ns.api.dhlab_api import geo_lookup
from dhlab_ns.text.parse import NER, Models
...
class GeoNames:
    ...
    def __init__(self, names, feature_class=None, feature_code=None):
        self.places = geo_lookup(
            names, feature_class=feature_class, feature_code=feature_code
        )
