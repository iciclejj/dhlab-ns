...
from dhlab_ns.api.dhlab_api import ngram_book, ngram_news
from dhlab_ns.ngram.nb_ngram import nb_ngram
...
class NgramNews(Ngram):
    def __init__(
        self, words=None, title=None, city=None, from_year=None, to_year=None, **kwargs
    ):
        super().__init__(
            words, from_year=from_year, to_year=to_year, doctype="avis", **kwargs
        )
        self.date = datetime.now()
